...
bool mathLineIntersection(Line_d l1, Line_d l2)
{
  ...
  sLeft.x = roundf((l1.p1.x + m1.x * r) * 100) / 100;
  sLeft.y = roundf((l1.p1.y + m1.y * r) * 100) / 100;
  sRight.x = roundf((l2.p1.x + m2.x * t) * 100) / 100;
  sRight.y = roundf((l2.p1.y + m2.y * t) * 100) / 100;
